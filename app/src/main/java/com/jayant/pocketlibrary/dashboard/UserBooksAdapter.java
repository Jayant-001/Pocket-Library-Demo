...
public class UserBooksAdapter extends FirebaseRecyclerAdapter<PdfData, UserBooksAdapter.BookViewHolder> {


    public UserBooksAdapter(@NonNull FirebaseRecyclerOptions<PdfData> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull UserBooksAdapter.BookViewHolder holder, int position, @NonNull PdfData model) {
